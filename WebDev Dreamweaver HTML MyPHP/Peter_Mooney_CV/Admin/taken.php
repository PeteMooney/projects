...
<h2>Virtue Alone Enobles.</h2>
  ...
  <div class="content">
      ...
      <div align="center">
        <h2>User name is taken</h2>
        <h2>&nbsp;</h2>
        <h3>Sorry the username and or password you have chosen already exists please return to the <a href="#">registration</a> page and try again.</h3>
        <p>&nbsp;</p>
      </div>
      <!-- InstanceEndEditable -->
  </div>
