...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO feedback (Name, Email, Subject, Message) VALUES (%s, %s, %s, %s)",
  ...
  $insertGoTo = "Templates/index.dwt.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_test, $test);
$query_Atend_Interview = "SELECT * FROM feedback";
$Atend_Interview = mysql_query($query_Atend_Interview, $test) or die(mysql_error());
$row_Atend_Interview = mysql_fetch_assoc($Atend_Interview);
$totalRows_Atend_Interview = mysql_num_rows($Atend_Interview);
?>
...
<title>Peter Money Attend_Interview.</title>
<!-- InstanceEndEditable -->
...
<li><a href="view_feedback.php">View Feedback</a></li>
  ...
  <div class="content">
      ...
      <h2 align="center" id="Attend_Interview">We would like you to attend interview.</h2>
      <p align="center">&nbsp;</p>
...
<!-- InstanceEnd --></html>
<?php
mysql_free_result($Atend_Interview);
?>
